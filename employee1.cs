...
public class Program
{
    ...
    public static void PrintList(Employee[] listOfEmployess)
    {
        for (int i = 0; i < listOfEmployess.Length; i++)
        {
            ...
            string fn = listOfEmployess[i].FirstName;
            string ln = listOfEmployess[i].LastName;
            double sal = listOfEmployess[i].Salary;
